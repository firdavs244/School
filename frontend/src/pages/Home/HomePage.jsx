          ...
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ textAlign: 'center' }}>
              <Statistic
                ...
                prefix={<TeamOutlined />}
                suffix="+"
                styles={{ content: { color: '#1890ff', fontSize: '36px' } }}
              />
            </Card>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ textAlign: 'center' }}>
              <Statistic
                ...
                prefix={<UserOutlined />}
                suffix="+"
                styles={{ content: { color: '#52c41a', fontSize: '36px' } }}
              />
            </Card>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ textAlign: 'center' }}>
              <Statistic
                ...
                prefix={<BookOutlined />}
                suffix="+"
                styles={{ content: { color: '#722ed1', fontSize: '36px' } }}
              />
            </Card>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Card hoverable style={{ textAlign: 'center' }}>
              <Statistic
                ...
                suffix="+"
                styles={{ content: { color: '#faad14', fontSize: '36px' } }}
              />
            </Card>
          </Col>
        </Row>
