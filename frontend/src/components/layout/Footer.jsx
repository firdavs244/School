// Footer komponenti - Yangilangan versiya
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} sm={12} lg={6}>
            <Space orientation="vertical" size="middle">
              ...
              <Space size="large">
                ...
                <a href="#" className="footer-social-icon"><TwitterOutlined /></a>
          ...
          <Col xs={24} sm={12} lg={6}>
            ...
            <Space orientation="vertical">
              <Link to={ROUTES.HOME} className="footer-link">Bosh sahifa</Link>
              <Link to={ROUTES.BROWSE_COURSES} className="footer-link">Kurslar</Link>
              {isLoggedIn ? (
                <Link to={ROUTES.DASHBOARD} className="footer-link">Boshqaruv Paneli</Link>
              ) : (
                <>
                  <Link to={ROUTES.LOGIN} className="footer-link">Kirish</Link>
                  <Link to={ROUTES.REGISTER} className="footer-link">Ro'yxatdan o'tish</Link>
                </>
              )}
            </Space>
          </Col>
